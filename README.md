...
1. The core features of Node.js and Express and why they are useful.
   Node: same language(JS), single threaded(easier to track everything), asynchronous(uses full power of processor it's running on), npm libraries(largest ecosystem in the world)
   Express: simple, easy to use, compatible with middlewares

1. Understand and explain the use of Middleware.
   they help us keep code DRY because of their reusability and as a result we can avoid many weird problems related with typos and carelessness
...
1. Understand and explain the use of Express Routers.
   it lets us brake code for smaller pieces to make it easier to control and track for errors. also it looks beautier

1. Describe tooling used to manually test the correctness of an API.
   some programs like Postman help us test API very easy because they have many tools which do all needed CRUD operations with API and beyond
